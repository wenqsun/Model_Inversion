...
echo "FedAvg, FedProx, FedPAQ, FedAvgDP and FedPAQDP on CIFAR100"
echo "FedAvg"
CUDA_VISIBLE_DEVICES=5 nohup python train_inversion.py --FL_algorithm FedAvg --acc 66.81 --num_epoch 15000 --log_interval 500 &
wait

echo "FedProx"
CUDA_VISIBLE_DEVICES=5 nohup python train_inversion.py --FL_algorithm FedProx --acc 68.53 --num_epoch 15000 --log_interval 500 &
wait

echo "FedPAQ"
CUDA_VISIBLE_DEVICES=5 nohup python train_inversion.py --FL_algorithm FedPAQ --acc 61.72 --num_epoch 15000 --log_interval 500 &
wait

echo "FedAvgDP"
CUDA_VISIBLE_DEVICES=5 nohup python train_inversion.py --FL_algorithm FedAvgDP --acc 61.45 --num_epoch 15000 --log_interval 500 &
wait

echo "FedPAQDP"
CUDA_VISIBLE_DEVICES=5 nohup python train_inversion.py --FL_algorithm FedPAQDP --acc 56.66 --num_epoch 15000 --log_interval 500 &
wait



echo "different data augmentation defense for FedAvg and FedProx on CIFAR10"
echo "FedAvg: Noise, Random Flip and local mixup"
CUDA_VISIBLE_DEVICES=5 nohup python train_inversion.py --FL_algorithm FedAvg --acc 59.72 --num_epoch 15000 --log_interval 500 &
wait
CUDA_VISIBLE_DEVICES=5 nohup python train_inversion.py --FL_algorithm FedAvg --acc 70.45 --num_epoch 15000 --log_interval 500 &
wait
CUDA_VISIBLE_DEVICES=5 nohup python train_inversion.py --FL_algorithm FedAvg --acc 68.8 --num_epoch 15000 --log_interval 500 &
wait

echo "FedPAQ: Noise, Random Flip and local mixup"
CUDA_VISIBLE_DEVICES=5 nohup python train_inversion.py --FL_algorithm FedPAQ --acc 47.31 --num_epoch 15000 --log_interval 500 &
wait
CUDA_VISIBLE_DEVICES=5 nohup python train_inversion.py --FL_algorithm FedPAQ --acc 61.45 --num_epoch 15000 --log_interval 500 &
wait
CUDA_VISIBLE_DEVICES=5 nohup python train_inversion.py --FL_algorithm FedPAQ --acc 61.74 --num_epoch 15000 --log_interval 500 &
