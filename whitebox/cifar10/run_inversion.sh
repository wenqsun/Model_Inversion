...
CUDA_VISIBLE_DEVICES=0 python train_inversion.py --FL_algorithm FedAvg --acc 66.81 --num_epoch 10000 --log_interval 100 &

CUDA_VISIBLE_DEVICES=1 python train_inversion.py --FL_algorithm FedProx --acc 68.53 --num_epoch 10000 --log_interval 100 &

CUDA_VISIBLE_DEVICES=2 python train_inversion.py --FL_algorithm FedPAQ --acc 61.72 --num_epoch 10000 --log_interval 100 &

CUDA_VISIBLE_DEVICES=3 python train_inversion.py --FL_algorithm FedPAQ --acc 47.31 --num_epoch 10000 --log_interval 100 &

CUDA_VISIBLE_DEVICES=4 python train_inversion.py --FL_algorithm FedPAQDP --acc 57.74 --num_epoch 10000 --log_interval 100 &

CUDA_VISIBLE_DEVICES=5 python train_inversion.py --FL_algorithm FedAvgDP --acc 61.45 --num_epoch 10000 --log_interval 100 &
