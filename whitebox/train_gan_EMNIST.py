...
if __name__ == '__main__':
    ...
    train_dataset = dsets.EMNIST(root = '../data', split = 'bymerge', train = True, transform = transform, download = True)
    ...
    for epoch in range(1, args.num_epochs+1):
        ...
        # save images
        if epoch % 5 == 0:
            tvls.save_image(x_fake.data, './result/GAN_EMNIST/{}.png'.format(epoch), normalize = True)

    torch.save(G.state_dict(), 'GAN_EMNISTGenerator.pkl')
    torch.save(D.state_dict(), 'GAN_EMNISTDiscriminator.pkl')     